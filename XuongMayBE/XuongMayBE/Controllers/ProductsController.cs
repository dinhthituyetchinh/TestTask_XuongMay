...
>>>>>>> bbf5269f59eddc4725de82628dd88acc2b592a24
...
=======
        ...
        public ProductsController(GarmentFactoryContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Product>> PostProduct(Product product)
        {
          if (_context.Product == null)
          {
              return Problem("Entity set 'GarmentFactoryContext.Product'  is null.");
          }
